...
function appConfig(options) {
  ...
  try {
    options = require((0, import_path.join)(process.cwd(), "pterojs.json"));
...
var BackupManager = class extends BaseManager {
  ...
  async download(id, dest) {
    ...
    (0, import_fs.writeFileSync)(dest, data.toString(), { encoding: "utf-8" });
  }
  async restore(id) {
    await this.client.requests.post(
...
var FileManager = class {
  ...
  async download(path, dest) {
    ...
    const data = await this.client.requests.raw("GET", url);
    (0, import_fs2.writeFileSync)(dest, data.toString(), { encoding: "utf-8" });
  }
...
// src/client/ws/Shard.ts
var Shard = class extends import_events2.EventEmitter {
  ...
  async connect() {
    ...
    this.socket = new import_ws.WebSocket(auth.data.socket, origin);
