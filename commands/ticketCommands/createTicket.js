    ...
    async execute(interaction) {
        ...
        let sendChannel = channel.send({
            ...
            components: [
                new ActionRowBuilder().setComponents(
                    new ButtonBuilder().setCustomId('createTicket').setLabel('Create a ticket!').setStyle(ButtonStyle.Success),
                ),
            ],
        });
        ...
        collector.on('collect', async i => {
            ...
            const ticketCreate = new EmbedBuilder()
                ...
                .setColor('Green')
                .setDescription(`Thanks for creating a ticket ${i.user}, someone will get to you as soon as they can!`)

            channel.send({ embeds: [ticketCreate] })
